package org.crmframework.core.minidao.util;
...
public class MiniDaoUtil {
	private static final Logger logger = LoggerFactory.getLogger(MiniDaoUtil.class);
	...
	public static String createPageSql(String dbType, String sql, int page,
		...
		if (jdbcType == null || "".equals(jdbcType)) {
			throw new RuntimeException(
					"org.eispframework.minidao.aop.MiniDaoHandler:(数据库类型:dbType)没有设置,请检查配置文件");
		}
