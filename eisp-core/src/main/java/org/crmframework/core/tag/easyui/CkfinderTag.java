...
public class CkfinderTag extends TagSupport {
    ...
    public StringBuffer end() {
        ...
        if ("Images".equals(uploadType)) {
            sb.append("<img src=\"" + value + "\" width=\"" + width + "\" height=\"" + height + "\" id=\"" + name
                            + "_herf\" ");
        ...
        sb.append("<input class=\"" + buttonClass + "\" type=\"button\" value=\"" + buttonValue
                        + "\" onclick=\"browse('" + name + "_input','" + name + "_herf','" + uploadType + "')\">");
        return sb;
    }
}
