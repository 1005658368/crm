...
public class PagerUtil {
    ...
    protected StringBuffer getStrByImage(StringBuffer sb) {
        ...
        sb.append(" }else{" + "\n");
        sb.append("    document.getElementById('pageGoto').href='" + actionUrl + join + "curPageNO='+val+'"
                        + conditions + "';" + "\n");
        sb.append("    return true ;" + "\n");
        sb.append("} " + "\n");
        sb.append(" }" + "\n");
        sb.append("</script>" + "\n");
        sb.append("&nbsp;<span class=pageArea id=pageArea>共<b>" + rowsCount + "</b>条&nbsp;当前第" + curPageNO + "/"
                        + pageCount + "页&nbsp;&nbsp;&nbsp;");
        if (isFirst())
            ...
            sb.append("<a href='" + actionUrl + join + "curPageNO=1" + conditions
                            + "' class=pageFirst title=首页 onMouseMove=\"style.cursor='hand'\"></a>");
            sb.append("<a class=\"pagePrevious\" href='" + actionUrl + join + "curPageNO=" + previous() + conditions
        ...
        if (curPageNO - pageCount == 0 || pageCount == 0 || pageCount == 1)
            ...
            sb.append("<a class=pageNext href='" + actionUrl + join + "curPageNO=" + next() + conditions
                            + "' title=下一页 onMouseMove=\"style.cursor='hand'\")\">&nbsp;</a>");
            sb.append("<a class=pageLast href='" + actionUrl + join + "curPageNO=" + pageCount + conditions
    ...
    protected StringBuffer getStr(StringBuffer sb) {
        ...
        if (isFirst())
            ...
            sb.append("第" + curPageNO + "页&nbsp;共" + pageCount + "页&nbsp;<a href='" + actionUrl + join + "curPageNO=1"
                            + conditions + "'>首页</a>&nbsp;");
            sb.append("<a href='" + actionUrl + join + "curPageNO=" + previous() + conditions
                            + "' onMouseMove=\"style.cursor='hand'\" alt=\"上一页\">上一页</a>&nbsp;");
        }
        if (isLast() || rowsCount == 0)
            sb.append("尾页&nbsp;");
        else {
            sb.append("<a href='" + actionUrl + join + "curPageNO=" + next() + conditions
        ...
        str += "&nbsp;转到<select name='page' onChange=\"location='" + actionUrl + join
