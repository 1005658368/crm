...
public class MenuTag extends TagSupport {
    ...
    public StringBuffer end() {
        ...
        // update-begin--Author:Biz Date:20140622 for：左侧树调整：加大宽度、更换节点图标、修改选中颜色
        ...
        // update-begin--Author:Biz Date:20140429 for：在IE7下 导航显示问题
        // {
        // sb.append("<div id=\"nav\" style=\"display:none;\" class=\"easyui-accordion\" fit=\"true\" border=\"false\">");
        {
            ...
            // update-end--Author:Biz Date:20140429 for：在IE7下 导航显示问题
