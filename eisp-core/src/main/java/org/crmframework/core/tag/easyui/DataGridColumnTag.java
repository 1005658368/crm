...
public class DataGridColumnTag extends TagSupport {
    ...
    protected String headcolor;// 表头背景颜色设置
    protected String fieldcolor;// 表格行内容背景颜色设置
    ...
    public int doEndTag() throws JspTagException {
        ...
        parent.setColumn(title, field, width, rowspan, colspan, align, sortable, checkbox, formatter, hidden, replace,
                        treefield, image, imageSize, query, url, funname, arg, queryMode, dictionary, frozenColumn,
                        extend, style, downloadName, autocomplete, extendParams, headcolor, fieldcolor);
        return EVAL_PAGE;
    }
    ...
    public void setField(String field) {
        this.field = field.contains(".") ? field.replace(".", "_") : field;
    }
