 ...
 * JSON和JAVA的POJO的相互转换
 * 
 * @author Biz JSONHelper.java
 */
public final class JSONHelper implements java.io.Serializable{
     ...
     */
    /*
     * public static Collection toCollection(Object object) { JSONArray jsonArray = JSONArray.fromObject(object);
     * 
    ...
    /**
     * 过滤掉hibernate实体里不需要的属性
     */
    public static String filterBeanToJson(final List<String> filterFied, Object bean){
    	JsonConfig jsonConfig = new JsonConfig();
    	
		PropertyFilter filter = new PropertyFilter() {
			public boolean apply(Object source, String name, Object value) {
				boolean isFiltered=false;
				for(String str : filterFied){
					if(str.equals(name)){
						isFiltered=true;
					}
				}
     ...
     * 去除json格式，key值引号
     */
  public static String removeJsonKeyQuotes(Object object){
 ...
 /**
   ...
   * @return
   */
  public static final void stringParseJavaBean(String result,Object...objects ){
