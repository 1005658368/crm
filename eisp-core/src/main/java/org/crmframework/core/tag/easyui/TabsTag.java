...
import org.crmframework.core.vo.Tab;
...
public class TabsTag extends TagSupport {
    ...
    public StringBuffer end() {
        ...
        if (iframe) {
            ...
            sb.append("{");
            sb.append("var s = \'<iframe id=\"\'+id+\'\" scrolling=\"no\" frameborder=\"0\"  src=\"about:eisp\" width=\""
        ...
        if (tabs) {
            ...
            sb.append("<div id=\"" + id + "\" tabPosition=\"" + tabPosition
                            ...
                            + oConvertUtils.getString(width, "auto") + ";\" class=\"easyui-tabs\" fit=\"" + fit + "\">");
            if (!iframe) {
                for (Tab tab : tabList) {
                    if (tab.getHref() != null) {
                        sb.append("<div title=\""
                                        ...
                                        + "\" href=\""
                                        + tab.getHref()
                                        + "\" style=\"margin:0px;padding:0px;overflow-x:hidden;overflow-y:auto;width=auto;\" id=\""
                                        + tab.getId() + "\"></div>");
                    } else {
                        sb.append("<div title=\""
                                        + tab.getTitle()
