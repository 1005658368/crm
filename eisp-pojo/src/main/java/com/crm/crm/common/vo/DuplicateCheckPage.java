 ...
 * @作者:Biz
 * @E-mail:
 * @日期:2012-11-15 update-begin--Author:yankang Date:201309012 for：[TASK#63]UI库常用控件参考示例【重复校验】 update-end--Author:yankang
 *                Date:20130912 for：[TASK#63]UI库常用控件参考示例【重复校验】
 */
