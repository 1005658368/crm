...
<div id="system_function_functionList" class="easyui-layout" fit="true"><%--   update-end--Author:duanql  Date:20130619 for：操作按钮窗口显示控制--%>
    <div region="center" style="padding: 1px;">
        <t:datagrid name="functionList"
            ...
            <t:dgCol title="funcType" field="functionType" treefield="functionType" replace="funcType.page_0,funcType.from_1,funcType.phone_2"></t:dgCol>
...
<script type="text/javascript">
    ...
    function operationDetail_msg(functionId)
    {
        if(li_east == 0){
            $('#system_function_functionList').layout('expand','east');
        }
        $('#operationDetailpanel').panel("refresh", "messageController.do?errorMsgList&menuId=" +functionId);
    }
    <%--   update-end--Author:anchao  Date:20130415 for：按钮权限控制--%>
