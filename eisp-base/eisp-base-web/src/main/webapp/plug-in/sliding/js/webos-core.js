...
//	dataFlush();
	...
	var num =totalnum+1 ,////替换掉一级菜单的总数量
		defaultnum=1,
		title = "请登录",
		usericon = "plug-in/sliding/images/eispisp.png";
...
//    update-begin--Author:Biz  Date:20140605 for：云桌面全局视图，菜单区内容的高度bug修复（有滚动条时，最后一个菜单被windows底部菜单栏遮盖的bug）
...
//    update-end--Author:Biz  Date:20140605 for：云桌面全局视图，菜单区内容的高度bug修复（有滚动条时，最后一个菜单被windows底部菜单栏遮盖的bug）
...
//		this.app = DATA.app[fid];
	...
	create:function(){	
		...
		this.box.attr({
			...
			title:this.app.name,
//            update-begin--Author:Biz  Date:20140605 for：云桌面全局视图，添加菜单点击功能（弹出菜单后，关闭全局视图并返回桌面）
            url: this.app.url,
//            update-end--Author:Biz  Date:20140605 for：云桌面全局视图，添加菜单点击功能（弹出菜单后，关闭全局视图并返回桌面）
		...
		appIcon.append($("<img>",{
			alt:this.app.name ,
            /*update-begin--Author:Biz  Date:20140509 for：云桌面图标管理*/
//			src:'plug-in/sliding/icon/'+this.app.icon,
			src:this.app.icon,
            /*update-end--Author:Biz  Date:20140509 for：云桌面图标管理*/
