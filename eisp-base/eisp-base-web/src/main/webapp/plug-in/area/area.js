 ...
 * 省市区三级联动 plugin
 * 
 * Copyright (c) 2014 萧峰 (biweb.cn) Dual licensed under the MIT and GPL
 * licenses: http://www.gnu.org/licenses/gpl.html
 * 
 */
...
function initArea(provEleId, cityEleId, areaEleId, defaultVal) {
    var vp = '';
    var vc = '';
    var va = '';
    if (defaultVal != 'undefined' && defaultVal != '') {
        if (defaultVal.replace('0000', '').length == 2) {
            vp = defaultVal;
        } else {
            vp = defaultVal.substring(0, 2) + '0000';
            if (vp == '100000' || vp == '120000' || vp == '310000' || vp == '500000' || vp == '710000'
                    || vp == '810000' || vp == '820000') {
                vc = defaultVal;
            } else {
                vc = defaultVal.substring(0, 4) + '00';
                va = defaultVal;
            }
        }
    }
    getProvinces(provEleId, vp);
    if (typeof (cityEleId) != 'undefined') {
        getCitys(cityEleId, provEleId, vc);
    }
    if (typeof (areaEleId) != 'undefined') {
        getAreas(areaEleId, cityEleId, va);
    }
}

function codeToAddress(defaultVal){
    var vp = '';
    var vc = '';
    var va = '';
    if (defaultVal != 'undefined' && defaultVal != null && defaultVal != '' && defaultVal.length == 6) {
        if (defaultVal.replace('0000', '').length == 2) {
            vp = defaultVal;
            return __alldiv[vp][0];
        } else {
            vp = defaultVal.substring(0, 2) + '0000';
            if (vp == '100000' || vp == '120000' || vp == '310000' || vp == '500000' || vp == '710000'
                    || vp == '810000' || vp == '820000') {
                vc = defaultVal;
                return __alldiv[vp][0] + __alldiv[vc][0];
            } else {
                vc = defaultVal.substring(0, 4) + '00';
                va = defaultVal;
                return __alldiv[vp][0] + __alldiv[vc][0] + __alldiv[va][0];
            }
        }
    }else{
        return '';
